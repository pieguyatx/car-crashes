...
ylabel('Crashes')
%axis([1 n 0 2500 ])
title('Texas monthly crashes, showing linear trend')
...
%axis([1 n -3000 3000 ])
title('Texas monthly crashes, detrended')
...
spreadmetric = [ModelCHECK.noisevariance; var(modeleddata); ...
    var(modeleddata)/ModelCHECK.noisevariance];
