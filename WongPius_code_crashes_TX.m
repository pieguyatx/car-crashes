...
ylabel('Crashes')
axis([1 2557 0 2500 ])
title('Texas daily crashes, showing linear trend')
...
axis([1 2557 -1000 1500 ])
title('Texas daily crashes, detrended')
...
axis([0 n -1000 1500 ])
title('Actual vs. Modeled Texas daily crashes, detrended')
legend('Actual', 'Model')
