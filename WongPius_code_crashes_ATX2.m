...
% assume y = B0 + B1xt + et
num = ATX_daily ;  %choose which dataset to analyze; THIS CHANGES
...
ylabel('Crashes')
axis([1 n 0 100 ])
title('Austin daily crashes, showing linear trend')
...
axis([1 n -50 60 ])
title('Austin daily crashes, detrended')
...
axis([1 n -50 60 ])
title('Actual vs. Modeled Austin daily crashes, detrended')
legend('Actual', 'Model')
