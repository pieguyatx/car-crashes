...
%% Checking (1-b52) operator: get new parsimonious ARMA
for i=53:size(data,1)  %shift data to find Yt
    j = i-52;
        data2(j,1) = data(i,1) - data(i-52,1);
end
na = 52;  % AR order
nc = 51;  % MA order
...
thetas2 = [Model2.c; Model.dc]';
CurrentEstimationInfo=Model2.EstimationInfo;
RSS3 = CurrentEstimationInfo.LossFcn*(n-na-nc)
